...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 *   => 이 때, 서브클래스 생성자에서 슈퍼클래스의 기본생성자를 자동 호출
		 *   => 만약, 슈퍼클래스에 파라미터 생성자만 존재할 경우
		 *      서브클래스 생성자에서 컴파일 에러가 발생하게 됨.
		 *      
		 * < 생성자 super() >
...
//		this.isStudyMode = isStudyMode;
		...
		super(name,age); // 슈퍼클래스 생성자에 name, age를 전달하여 대신 초기화
		this.isStudyMode = isStudyMode;
